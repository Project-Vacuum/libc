...
## [0.2.159](https://github.com/Project-Vacuum/libc/compare/0.2.158...0.2.159) - 2024-09-10
...
- Merge pull request [#3900](https://github.com/Project-Vacuum/libc/pull/3900) from tgross35/espid-cherry-pick
...
- Merge pull request [#3877](https://github.com/Project-Vacuum/libc/pull/3877) from tgross35/backport-butternut
- Add `wasm32-wasip2` to the test matrix on CI
- Re-enable testing of WASI on CI
- Merge pull request [#3873](https://github.com/Project-Vacuum/libc/pull/3873) from tgross35/backport-cilantro
